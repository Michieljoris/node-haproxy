...
module.exports = {
    ...
    "homepage": "https://github.com/michieljoris/node-haproxy",
    ...
    "repository": {
        "type": "git",
        "url": "https://github.com/michieljoris/node-haproxy.git"
    },
    ...
    "licenses": [
        {
            "type": "MIT",
            "url": "http://github.com/michieljoris/node-haproxy/blob/master/LICENSE.txt"
        }
    ],
    ...
    //Installs a binary script called node-haproxy which is linked to
    //./bin/node-haproxy in the local package.

    //If we have installed this package globally using npm install node-haproxy
    //-g we will be able to call this new command node-haproxy from anywhere on
    //our system.
    "bin": {
	// "commit": "bin/node-haproxy.js"
    },
