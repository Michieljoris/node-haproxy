var log = require('logthis').logger._create('Db');
...
//
var Db = module.exports = function(opts, cb) {
    var self = this;
    ...
    var rs = self.statsDb.createReadStream({ keys: true, values: false })
        .on('data', function (key) {
            ...
            if (epoch < timeToExpire) {
                //self.log('trimStats deleting (' + (epoch - timeToExpire) + ') ' + key);
