...
var log = require('logthis').logger._create('test');
...
var optimist = require('optimist')
    .options({
        ...
        persistence: { default: __dirname + '/persisted',
